                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <input type="text" name="empresa" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        ...
                                        <div class="dm-select-list d-flex">
                                            <div class="dm-select ">
                                                <select  name="empresa" id="select-search" class="form-control ">
                                                    @foreach($enterprises as $enterprise)
                                                    <option value="{{ $enterprise->id }}">{{        $enterprise->razon_social }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{-- <input type="text" name="forma_pago" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        ...
                                        <div class="dm-select-list d-flex">
                                            <div class="dm-select ">
                                                <select  name="payment_method" id="select-search" class="form-control ">
