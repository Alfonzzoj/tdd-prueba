                        ...
                        <div class="card-body py-md-25">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="rfc"
                                            ...
                                            placeholder="Ingrese RFC" required>
                                    </div>
                                </div>
                                {{-- razon social --}}
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="empresa"
                                            class="il-gray fs-14 fw-500 align-center mb-10">Empresa</label>
                                        <div class="w-full">
                        ...
                        <div class="card-header">
                            ...
                            <div class="drawer-btn d-flex justify-content-center">
                                <button class="btn btn-primary btn-default btn-squared drawer-trigger"
                                    data-drawer="account">Crear </button>
                            </div>
                                    ...
                                    <form action="#">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    <label for="nombre_direccion"
                                                        class="il-gray fs-14 fw-500 align-center mb-10">Nombre
                                                        direccion</label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="zona_entrega"
                                                        class="il-gray fs-14 fw-500 align-center mb-10">Zona
                                                        entrega</label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="dias_semana_para_entrega"
                                                    ...
                                                    entrega</label>
                                                <div class="dm-select ">
                                                    <select name="dias_semana_para_entrega[]"
                                                        id="dias_semana_para_entrega"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="dm-select ">
                                            <select name="dias_semana_para_entrega_ctc[]"
                                                id="dias_semana_para_entrega_ctc" class="form-control select-multiple"
                ...
                <div class="col-lg-12">
                    <div class="card card-default card-md mb-4">
                        <div class="card-header">
                            ...
                            <div class="drawer-btn d-flex justify-content-center">
                                <button class="btn btn-primary btn-default btn-squared drawer-trigger"
                                    data-drawer="profile">Crear </button>
                            </div>
