                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="calle" class="form-control ih-medium ip-light radius-xs b-light px-15"
                      id="calle" placeholder="Ingrese la calle" required value="{{ $client->taxAddress->calle ?? ''}}">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nombre_direccion"
                      ...
                      placeholder="Ingrese la direccion" value="{{ $client->deliveryZones[0]->nombre_direccion ?? ''}}">
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="zona_entrega"
                      ...
                      placeholder="Ingrese zona de entrega" value="{{ $client->deliveryZones[0]->zona_entrega?? '' }}"">
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="calle_zona_entrega"
                        ...
                        placeholder="Ingrese la calle" value="{{ $client->deliveryZones[0]->calle ?? ''}}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="no_externo_zona_entrega"
                        ...
                        placeholder="Ingrese no externo" value="{{ $client->deliveryZones[0]->numero_externo?? '' }}"">
                                </div>
                            </div>
                            {{-- No interno ze--}}
                            <div class=" col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="no_interno_zona_entrega"
                          ...
                          placeholder="Ingrese no interno" value="{{ $client->deliveryZones[0]->numero_interno?? '' }}">
                      </div>
                    </div>
                    {{-- Codigo postal ze --}}
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="colonia_zona_entrega"
                          ...
                          placeholder="Ingrese la colonia" value="{{ $client->deliveryZones[0]->colonia?? '' }}">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="delegacion_zona_entrega"
                          ...
                          placeholder="Ingrese la delegación" value="{{ $client->deliveryZones[0]->delegacion ?? ''}}">
                      </div>
                    </div>
                    {{-- Estado zona entrega --}}
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="estado_zona_entrega"
                          ...
                          placeholder="Ingrese el estado" value="{{ $client->deliveryZones[0]->estado ?? ''}}">
                      </div>
                    </div>
                    {{-- pais zona entrega --}}
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="pais_zona_entrega"
                          ...
                          placeholder="Ingrese el país" value="{{ $client->deliveryZones[0]->pais?? '' }}">
                      </div>
                    </div>
                ...
                <div class="card card-default card-md mb-4">
                  ...
                  <div class="card-body py-md-25">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="puesto_contacto"
                            ...
                            placeholder="Ingrese puesto del contacto" value="{{ $client->contacts[0]->puesto?? '' }}">
                        </div>
                      </div>
                      ...
                      {{-- Dias de entrega --}}
                      <div class="col-md-6">
                        <label for="dias_semana_para_entrega_ctc" class="il-gray fs-14 fw-500 align-center mb-10">Dias
                          de
                          entrega</label>
                        <div class="dm-select ">
