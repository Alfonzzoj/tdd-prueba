                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="modal-basic modal fade show" id="modal-items-{{ $client->id }}" tabindex="-1"
                                                                ...
                                                                <table id="dt-pedidos"
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <ul
                                                                                    class="orderDatatable_actions mb-0 d-flex flex-wrap justify-center items-center">
                                                ...
                                                <div class="col">
                                                    <table id="dt-estados-cuenta"
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <tr>
                                                                <th colspan="3" style="text-align:right">Total Pagado:
                                                                </th>
                                                                <th colspan="3"><span id="totalPagado2">$150.00</span>
                                                                </th>
                                                            </tr>
                                                            <tr>
                                ...
                                {{-- Pedidos --}}
                                <div class="modal-basic modal fade show" id="modal-pedidos-{{ $client->id }}"
                                    tabindex="-1" role="dialog" aria-hidden="true">
