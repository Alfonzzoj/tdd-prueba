    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="breadcrumb-main">
                <h4 class="text-capitalize breadcrumb-title">Metodos de pago</h4>
                ...
                <div class="breadcrumb-main m-0 breadcrumb-main--table justify-content-sm-between ">
                    <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                        <div class="d-flex align-items-center ticket__title justify-content-center me-md-25 mb-md-0 mb-20">
                            {{-- TODO: traducir --}}
                            <h4 class="text-capitalize fw-500 breadcrumb-title">Informacion de Metodos de pago  registrados</h4>
                        </div>
                    </div>
                    <div class="action-btn">
                        <a href="{{ route('payment_methods.create',app()->getLocale()) }}" class="btn btn-primary">
                            Nuevo
                        </a>
                                        ...
                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                            ...
                                            <li>
                                                <a href="{{
                                                    ...
                                                    ['payment_method'=>$payment_method->id,'language'=>app()->getLocale()] ) }}" class="show">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{
                                                    route('payment_methods.edit',
                                                    ['payment_method'=>$payment_method->id,'language'=>app()->getLocale()] ) }}" class="edit">
                                            ...
                                            <li>
                                                ...
                                                <a href="{{ route('payment_methods.destroy', ['language' => app()->getLocale(), 'payment_method' => $payment_method->id]) }}"
                                                    onclick="event.preventDefault(); document.getElementById('delete-form').submit();"  class="remove">
                                                    <i class="uil uil-trash-alt"></i>

                                                 </a>

                                                 <form id="delete-form" action="{{ route('payment_methods.destroy', ['language' => app()->getLocale(), 'payment_method' => $payment_method->id]) }}"
