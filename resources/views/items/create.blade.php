                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nombre_etiqueta"
                                            class="il-gray fs-14 fw-500 align-center mb-10">Cliente</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="clave_item" class="il-gray fs-14 fw-500 align-center mb-10">Clave
                                            del item</label>
                                        <input type="text" name="clave_item"
                                            class="form-control ih-medium ip-light radius-xs b-light px-15"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="nombre_etiqueta"
                                            class="il-gray fs-14 fw-500 align-center mb-10">Nombre etiqueta </label>
                                        <input type="text" name="nombre_etiqueta"
                                            class="form-control ih-medium ip-light radius-xs b-light px-15"
                                            id="nombre_etiqueta" placeholder="Ingrese nombre de la etiqueta" required>
                                    </div>
