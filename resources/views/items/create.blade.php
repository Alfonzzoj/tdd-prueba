...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="breadcrumb-main">
                <h4 class="text-capitalize breadcrumb-title">Crear Item</h4>
    ...
    <div class="form-element">
        ...
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="clave_item" class="il-gray fs-14 fw-500 align-center mb-10">Clave del item</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="nombre_etiqueta" class="il-gray fs-14 fw-500 align-center mb-10">Nombre etiqueta </label>
                                    <input type="text" name="nombre_etiqueta" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        id="nombre_etiqueta" placeholder="Ingrese nombre de la etiqueta" required>
                                </div>
                            </div>
            ...
            {{-- Informacion Cliente/Stock --}}
            <div class="col-lg-6">
                <div class="card card-default card-md mb-4">
                    <div class="card-header">
                        <h6>Informacion Cliente/Stock </h6>
                    </div>
                    <div class="card-body py-md-25">
                        <div class="row">
            ...
            <!-- ends: Informacion Cliente/Stock-->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="no_interno" class="il-gray fs-14 fw-500 align-center mb-10">No
                                            interno</label>
                                        <input type="text" name="no_interno" class="form-control ih-medium ip-light radius-xs b-light px-15" id="no_interno" placeholder="Ingrese no interno" required>
                                    </div>
                                </div>
                                {{-- Codigo postal --}}
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pais_dominio_fiscal" class="form-control ih-medium ip-light radius-xs b-light px-15"
                                            id="pais" placeholder="Ingrese el país">
                                    </div>
                                </div>
