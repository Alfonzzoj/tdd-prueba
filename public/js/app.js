...
function update_input_removal_status_field(self) {
  ...
  /* eslint-disable */
  (_console = console).log.apply(_console, _toConsumableArray(oo_oo("bde18dda_0", {
    field_key: field_key
  })));
  if (!field_key) {
    return;
  ...
  /* eslint-disable */
  (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("bde18dda_1", {
    field: field
  })));
  if (!field) {
    return;
